...
Banner.prototype.setup = function () {
  ...
  this.divRight.set({ width: '44%', height: '100%', right: "0", left: 'unset', backgroundColor: "#000" });
...
Banner.prototype.animate = function () {
  ...
  this.timeline = new TimelineMax({ repeat: maxLoops, paused: false, })
    ...
    .add(TweenMax.to(this.div, 0.8, { xPercent: 0, ease: Sine.easeOut, delay: -0.1 }))
    .add(TweenMax.to(this.txt3, 0.4, { autoAlpha: 0, ease: Sine.easeOut, delay: -0.4 }))
