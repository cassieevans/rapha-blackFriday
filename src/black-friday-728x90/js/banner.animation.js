...
Banner.prototype.setup = function () {
  ...
  this.divRight.set({ width: '28%', height: '100%', right: "0", left: 'unset', backgroundColor: "#000" });
...
Banner.prototype.animate = function () {
  ...
  this.timeline = new TimelineMax({ repeat: maxLoops, paused: false, })
    ...
    .add(TweenMax.to(this.div, 1.1, { xPercent: 100, ease: Sine.easeOut }))
    ...
    .add(TweenMax.from(this.txt1, 0.4, { autoAlpha: 0, ease: Sine.easeOut, delay: 0.2 }))
    ...
    .add(TweenMax.to(this.img2, 1, { autoAlpha: 0, ease: Sine.easeOutOut, delay: -0.1 }))
    .add(TweenMax.from(this.txt3, 0.4, { autoAlpha: 0, ease: Sine.easeOut, delay: 0.2 }))
    .call(function () {
    ...
    .add(TweenMax.to(this.div, 1.1, { xPercent: 0, ease: Sine.easeOut, }))
